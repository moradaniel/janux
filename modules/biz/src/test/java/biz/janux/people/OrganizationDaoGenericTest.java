 ...
 */
public class OrganizationDaoGenericTest extends TransactionalBizTestAbstractGeneric
{
	protected OrganizationDaoGeneric orgDaoGeneric;

	private final static String ORG_CODE = "JANUX";

	public OrganizationDaoGenericTest() {
		super();
	}
	...
	{
		Organization org = orgDaoGeneric.findByCode(ORG_CODE);
