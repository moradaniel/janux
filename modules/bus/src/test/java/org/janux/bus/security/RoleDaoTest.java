 ...
 */
public class RoleDaoTest extends TransactionalBusTestAbstract
{
	...
	public static Test suite()
	{
		...
		suite.addTest(new RoleDaoTest("testRoleWithNullAggrRoles"));
		return suite;
	}
	*/
	...
	public void testFindByName() 
	{
		...
		assertNull(roleDao.findByName("BOGUS"));
	}
