...
/**
 * Resolver for using Tiles and Velocity together. 
 * Allows to define attribute names for DateTool and NumberTool for all views.
 * 
 * @author <a href="mailto: pavel@jehlanka.cz">Pavel Mueller</a>
 * @author <a href="mailto:kirlen@janux.org">Kevin Irlen</a>
 */
public class TilesVelocityViewResolver extends AbstractTilesSpringViewResolver {
