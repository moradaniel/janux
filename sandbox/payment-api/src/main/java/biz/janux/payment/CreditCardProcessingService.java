...
/**
 * This service allow do all hotel credit card transactions which a credit card processor supports  
 *
 * @author albertobuffagni@gmail.com
 *
 */
public interface CreditCardProcessingService extends Serializable
{
	/**
	 ...
	 * If it is a payment, the system looks for a existent authorization. If it does not exist, the system processes one.
	 * 
	 * @param amount
	 * @param date
	 * @param creditCardUuid
	 ...
	 * @param externalSourceIdAuthorization TODO
	 * @param externalSourceId TODO
	 * @throws Exception
	 */
	...
	/**
	 * This method is used only for test. The test increments this number for avoid duplicated batch
	 *
	 * @param businessUnitUuid
	 *
	 * @deprecated
